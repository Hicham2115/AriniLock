...
export function Header() {
  ...
  const mobileLinkClass = "w-full border-b border-border py-5 font-display text-2xl tracking-wide text-foreground transition-colors hover:text-primary";
      ...
      <header className={`fixed inset-x-0 top-0 z-40 border-b border-border transition-all duration-300 ${scrolled ? "bg-white/70 backdrop-blur-md shadow-md" : "bg-white shadow-sm"}`}>
        <div className="mx-auto flex h-16 max-w-7xl items-center gap-1 px-4 sm:px-6 lg:px-8">
          ...
          <button
            ...
            className="flex items-center gap-2 rounded-md px-3 py-2 text-sm font-semibold text-foreground transition-colors hover:bg-secondary"
          >
          ...
          <div className="flex flex-1 items-center justify-end gap-1 md:flex-none">
            ...
            <button
              ...
              className="relative ml-1 flex h-10 w-10 items-center justify-center rounded-full text-foreground transition-colors hover:bg-secondary"
            >
            ...
            <button
              ...
              className="ml-1 flex h-10 items-center gap-2 rounded-full bg-black px-4 text-sm text-white transition-colors hover:bg-black/80"
            >
              <ShoppingBag aria-hidden="true" className="h-4 w-4" />
            ...
            {/* Language switcher */}
            <div className="ml-2 flex items-center gap-0.5 rounded-full border border-black/10 bg-secondary px-1 py-1">
              {LOCALES.map((loc) => (
                <button
                  key={loc}
                  type="button"
