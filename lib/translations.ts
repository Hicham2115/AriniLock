...
const fr = {
  ...
  m1pro: {
    ...
    reviews: [
      { name: "Youssef K.", city: "Casablanca", body: "L'écran intégré change tout — je vois qui sonne avant d'ouvrir. Parfait pour ma villa. La qualité est vraiment premium." },
      { name: "Salma R.",   city: "Marrakech",  body: "Idéal pour mon riad Airbnb. Je gère les codes à distance pour chaque locataire. Installation impeccable par l'équipe AriniLock." },
      { name: "Mehdi A.",   city: "Rabat",      body: "Le visiophone fonctionne parfaitement depuis mon téléphone. L'alarme anti-effraction m'a déjà alerté une fois. Top produit." },
    ],
    faqSection: "09 — FAQ",
  ...
  i60: {
    ...
    reviews: [
      { name: "Hamid B.",  city: "Rabat",       body: "Le design Push-Pull est vraiment premium. La reconnaissance faciale fonctionne même la nuit. Parfait pour ma villa." },
      { name: "Nadia T.",  city: "Casablanca",  body: "La caméra HD et l'écran intérieur changent tout — je vois qui sonne avant d'ouvrir. Très satisfaite." },
      { name: "Karim O.",  city: "Fès",         body: "La reconnaissance palmaire sans contact est bluffante. Installation rapide par l'équipe AriniLock. Je recommande !" },
    ],
    orderSection: "10 — Commander",
    orderTitle: "Prêt à sécuriser votre porte ?",
    orderDesc: "Remplissez le formulaire et notre équipe vous contacte sous 24h pour confirmer votre commande. Paiement à la livraison, partout au Maroc.",
...
• 2 mechanical keys · 2 RFID cards · Complete installation kit`,
  ...
  m1pro: {
    ...
    reviews: [
      { name: "Youssef K.", city: "Casablanca", body: "The built-in screen changes everything — I see who's ringing before opening. Perfect for my villa. Truly premium quality." },
      { name: "Salma R.",   city: "Marrakech",  body: "Ideal for my Airbnb riad. I manage codes remotely for each tenant. Flawless installation by the AriniLock team." },
      { name: "Mehdi A.",   city: "Rabat",      body: "The doorbell works perfectly from my phone. The anti-tamper alarm already alerted me once. Top product." },
    ],
    faqSection: "09 — FAQ",
    faqTitle: "Everything\nyou need to know.",
    faqs: [
  ...
  i60: {
    ...
    reviews: [
      { name: "Hamid B.",  city: "Rabat",      body: "The Push-Pull design is truly premium. Facial recognition works even at night. Perfect for my villa." },
      { name: "Nadia T.",  city: "Casablanca", body: "The HD camera and interior screen change everything — I see who's ringing before opening. Very satisfied." },
      { name: "Karim O.",  city: "Fès",        body: "The contactless palm recognition is stunning. Quick installation by the AriniLock team. Highly recommended!" },
    ],
    orderSection: "10 — Order",
    orderTitle: "Ready to secure your door?",
    orderDesc: "Fill in the form and our team will contact you within 24 hours to confirm your order. Cash on delivery, across Morocco.",
...
• مفتاحان ميكانيكيان · بطاقتا RFID · طقم تركيب كامل`,
  ...
  m1pro: {
    ...
    reviews: [
      { name: "يوسف ك.", city: "الدار البيضاء", body: "الشاشة المدمجة غيّرت كل شيء — أرى من يقرع الجرس قبل الفتح. مثالي لفيلتي. جودة فعلاً متميزة." },
      { name: "سلمى ر.", city: "مراكش",         body: "رائع لرياضي على Airbnb. أدير الرموز عن بُعد لكل مستأجر. تركيب ممتاز من فريق أريني لوك." },
      { name: "مهدي أ.", city: "الرباط",         body: "جرس الفيديو يعمل بشكل مثالي من هاتفي. إنذار الاقتحام نبّهني مرة من قبل. منتج رائع." },
    ],
  ...
  i60: {
    ...
    reviews: [
      { name: "حميد ب.", city: "الرباط",         body: "تصميم Push-Pull رائع فعلاً. التعرف على الوجه يعمل حتى ليلاً. مثالي لفيلتي." },
      { name: "نادية ت.", city: "الدار البيضاء", body: "الكاميرا HD والشاشة الداخلية غيّرتا كل شيء — أرى من يقرع الجرس قبل الفتح. راضية جداً." },
      { name: "كريم أ.", city: "فاس",            body: "قراءة راحة اليد اللاتلامسية مذهلة. تركيب سريع من فريق أريني لوك. أنصح به!" },
    ],
    orderSection: "10 — الطلب",
    orderTitle: "هل أنت مستعد لتأمين بابك؟",
    orderDesc: "أكمل النموذج وسيتصل بك فريقنا خلال 24 ساعة لتأكيد طلبك. الدفع عند الاستلام في جميع أنحاء المغرب.",
