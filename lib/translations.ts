    ...
    categories: [
      {
        ...
        subs: ["Contrôle d'accès employés", "Codes temporaires visiteurs", "Historique des accès"],
      },
      {
        label: "Solutions pour Airbnb",
        subs: ["Codes d'accès temporaires", "Gestion à distance (app)", "Visiophone & caméra"],
      },
      {
        label: "Solutions pour promoteurs",
        subs: ["Installation multi-logements", "Offres pour projets immobiliers", "Devis sur mesure"],
      },
      {
      ...
      },
      {
        ...
        subs: ["Visiophone & vision nocturne", "Serrure biométrique", "Sécurité résidentielle"],
      },
    ] as { label: string; subs: [string, string, string] }[],
    links: ["Fonctionnalités", "Comment ça marche", "Avis clients", "FAQ", "Contact & Support"] as string[],
  },
  hero: {
    buy: "Commander",
  ...
  product: {
    ...
    accordion: [
      ...
      },
      {
        ...
        content: "Produits certifiés CE (conformité européenne — sécurité électrique), RoHS (sans substances dangereuses) et ISO 9001 (système de management qualité). Agréés par l'ANRT.",
      },
      {
        value: "warranty",
        trigger: "Garantie & retours",
        content: "Garantie constructeur 2 ans sur tous les produits, couvrant tout défaut de fabrication. Retours acceptés sous 30 jours si le produit est dans son état d'origine. Assistance 7j/7 par WhatsApp.",
      },
    ],
    ...
    categories: [
      {
        ...
        subs: ["Employee access control", "Temporary visitor codes", "Access history"],
      },
      {
        label: "Airbnb solutions",
        subs: ["Temporary access codes", "Remote management (app)", "Video doorbell & camera"],
      },
      {
        label: "Developer solutions",
        subs: ["Multi-unit installation", "Real estate project offers", "Custom quotes"],
      },
      {
      ...
      },
      {
        ...
        subs: ["Video doorbell & night vision", "Biometric lock", "Residential security"],
      },
    ] as { label: string; subs: [string, string, string] }[],
    links: ["Features", "How it works", "Customer reviews", "FAQ", "Contact & Support"] as string[],
  },
  hero: {
    buy: "Order now",
  ...
  product: {
    ...
    accordion: [
      ...
      },
      {
        value: "certifications",
        trigger: "Certifications",
        content: "Every product is CE certified (European electrical safety compliance), RoHS certified (free of hazardous substances) and ISO 9001 certified (quality management system). Approved by ANRT.",
      },
      {
        value: "warranty",
        trigger: "Warranty & returns",
        content: "2-year manufacturer warranty on all products, covering all manufacturing defects. Returns accepted within 30 days if the product is in its original condition. Support 7 days a week via WhatsApp.",
      },
    ],
...
const ar: typeof fr = {
  ...
  nav: {
    ...
    categories: [
      ...
      },
      {
        ...
        subs: ["رموز دخول مؤقتة", "الإدارة عن بعد (التطبيق)", "جرس الباب بالفيديو والكاميرا"],
      },
      {
        label: "حلول للمطورين العقاريين",
        subs: ["تركيب لعدة وحدات", "عروض للمشاريع العقارية", "عروض أسعار مخصصة"],
      },
      {
        label: "حلول للفنادق",
    ...
    links: ["المميزات", "كيف يعمل", "آراء العملاء", "الأسئلة الشائعة", "التواصل والدعم"] as string[],
  },
  hero: {
    buy: "اطلب الآن",
  ...
  product: {
    ...
    accordion: [
      ...
      },
      {
        value: "certifications",
        trigger: "الشهادات",
        content: "جميع منتجاتنا حاصلة على شهادة CE (مطابقة أوروبية — السلامة الكهربائية)، وشهادة RoHS (خالية من المواد الخطرة)، وشهادة ISO 9001 (نظام إدارة الجودة). كما أنها معتمدة من طرف ANRT.",
      },
      {
        value: "warranty",
        trigger: "الضمان والإرجاع",
        content: "ضمان الصانع لمدة سنتين على جميع المنتجات يشمل جميع عيوب التصنيع. الإرجاع مقبول خلال 30 يومًا إذا كان المنتج في حالته الأصلية. دعم 7 أيام في الأسبوع عبر واتساب.",
      },
    ],
    ...
    specs: [
      ...
      { label: "التشطيبات", value: "أسود مطفأ · فضي · ذهبي" },
  ...
  contact: {
    ...
    channels: [
      ...
      { label: "الهاتف",  value: "+212 6 68 89 88 60", sub: "الاثنين–الجمعة · 9h–18h" },
      { label: "الهاتف 2", value: "+212 6 60 64 81 95", sub: "الاثنين–الجمعة · 9h–18h" },
