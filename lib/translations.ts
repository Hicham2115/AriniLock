...
const fr = {
  ...
  contact: {
    ...
    hours: "Disponible Lun–Sam · 9h–20h",
    online: "En ligne",
    channels: [
      { label: "WhatsApp",   value: "+212 6 00 00 00 00", sub: "Réponse en moins d'1 heure" },
      { label: "Téléphone",  value: "+212 6 00 00 00 00", sub: "Lun–Sam · 9h–20h" },
  ...
  sections: {
    ...
    reviews: {
      ...
      testimonials: [
        ...
        { title: "« On ne retourne pas en arrière »",            body: "Depuis qu'on a installé AriniLock, on n'a plus sorti une clé physique. Les enfants rentrent seuls après l'école, on reçoit une notif à chaque ouverture.",                                       author: "Karim M.",  city: "Rabat" },
        ...
        { title: "« Idéal pour les locations »",                 body: "Je gère trois appartements en location courte durée. Avec AriniLock, j'envoie un code temporaire à chaque locataire. Fini les remises de clés en main propre.",                                   author: "Hassan T.", city: "Fès" },
    ...
    footer: {
      ...
      taglineShort: "La serrure intelligente made in Morocco.",
...
• 2 mechanical keys · 2 RFID cards · Complete installation kit`,
  ...
  contact: {
    ...
    hours: "Available Mon–Sat · 9am–8pm",
    online: "Online",
    channels: [
      { label: "WhatsApp",  value: "+212 6 00 00 00 00", sub: "Response in under 1 hour" },
      { label: "Phone",     value: "+212 6 00 00 00 00", sub: "Mon–Sat · 9am–8pm" },
  ...
  sections: {
    ...
    reviews: {
      ...
      testimonials: [
        ...
        { title: "\"No going back\"",                          body: "Since we installed AriniLock, we haven't touched a physical key. The kids let themselves in after school and we get a notification every time the door opens.",                author: "Karim M.",  city: "Rabat" },
        ...
        { title: "\"Perfect for rentals\"",                    body: "I manage three short-term rental apartments. With AriniLock I just send a temporary code to each guest. No more meeting people in person to hand over keys.",                 author: "Hassan T.", city: "Fès" },
    ...
    footer: {
      ...
      taglineShort: "The smart lock made in Morocco.",
...
• مفتاحان ميكانيكيان · بطاقتا RFID · طقم تركيب كامل`,
  ...
  contact: {
    ...
    hours: "متاح الاثنين–السبت · 9ص–8م",
    online: "متصل",
    channels: [
      { label: "واتساب",  value: "+212 6 00 00 00 00", sub: "رد في أقل من ساعة" },
      { label: "الهاتف",  value: "+212 6 00 00 00 00", sub: "الاثنين–السبت · 9ص–8م" },
  ...
  sections: {
    ...
    footer: {
      ...
      taglineShort: "القفل الذكي صُنع في المغرب.",
