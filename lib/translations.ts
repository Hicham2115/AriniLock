...
const fr = {
  ...
  m1pro: {
    ...
    specs: [
      ...
      {
        label: "Modes d'ouvertures",
        value: "Code · Carte · Empreinte digitale · App · Clé mécanique",
      },
      {
        label: "Option",
        value: "Caméra HD pour surveiller les entrées/sorties",
      },
      {
        label: "Matériau",
        value: "Alliage d'aluminium",
      },
      ...
      { label: "Noyau de serrure", value: "Classe C (haute sécurité)" },
      {
        ...
        value: "38 à 110 mm · poignée réversible gauche/droite",
      },
      { label: "Mortaise standard", value: "5050 / 6068 — 24 × 240 mm" },
      { label: "Empreintes", value: "Jusqu'à 200" },
      { label: "Codes PIN", value: "Jusqu'à 150 utilisateurs" },
      { label: "Cartes IC/NFC", value: "Jusqu'à 200" },
      { label: "Alimentation", value: "8 piles AA alcalines" },
      { label: "Autonomie batterie", value: "12 mois (piles AA)" },
...
const en: typeof fr = {
  ...
  m1pro: {
    ...
    specs: [
      ...
      {
        label: "Opening modes",
        value: "Code · Card · Fingerprint · App · Mechanical key",
      },
      {
        label: "Option",
        value: "HD camera to monitor entries/exits",
      },
      {
        label: "Material",
      ...
      { label: "Lock cylinder", value: "Class C (high security)" },
      {
        ...
        value: "38–110 mm · reversible left/right handle",
      },
      { label: "Standard mortice", value: "5050 / 6068 — 24 × 240 mm" },
      { label: "Fingerprints", value: "Up to 200" },
      { label: "PIN codes", value: "Up to 150 users" },
      { label: "IC/NFC cards", value: "Up to 200" },
      { label: "Power", value: "8× AA alkaline batteries" },
      { label: "Battery life", value: "12 months (AA)" },
...
const ar: typeof fr = {
    ...
    faq: {
      ...
      items: [
        ...
        },
        {
          ...
          a: "تعمل أقفال ARINILOCK بالبطارية، مما يتيح لك فتح الباب باستخدام البصمة أو الرمز السري أو بطاقة RFID حتى في حال انقطاع التيار الكهربائي، طالما أن البطارية مشحونة. أما التحكم بالقفل وفتحه عن بُعد عبر التطبيق، فيتطلب اتصالًا بالإنترنت. وفي حال نفاد البطارية بالكامل، يمكنك استخدام المفتاح الميكانيكي الاحتياطي المرفق لفتح الباب بأمان، كما يمكنك أيضًا شحن القفل مؤقتًا عبر منفذ USB-C لاستعادة إمكانية استخدامه.",
        },
        {
          q: "كم تدوم البطارية؟",
  ...
  orderForm: {
    ...
    submitLabel: (price: string) => `أكمل طلبك — ${price}`,
    submitting: "جارٍ الإرسال…",
  ...
  m1pro: {
    ...
    features: [
      ...
      },
      {
        tag: "التطبيق",
        title: "تحكّم\nببابك من أي مكان\nفي العالم.",
        body: "يمكنك إدارة ما يصل إلى 200 مستخدم، والاطّلاع على سجل الدخول، وفتح الباب عن بُعد، وإنشاء رموز مؤقتة للزوار أو عمال التوصيل. إشعارات فورية وألبوم صور وتوافق مع Alexa وGoogle Home.",
        detail: "Alexa · Google Home · Tuya Smart",
      },
      {
        tag: "الأمان",
        title: "إنذارات.\nتنبيهات.\nحماية.",
        body: "يحتوي M1 Pro على نظام إنذار متعدد المستويات: تنبيه البطارية المنخفضة، إنذار محاولة الاقتحام، قفل بعد 5 رموز خاطئة متتالية ورمز مضاد للتجسس. كما يوفر زر القفل الداخلي حماية للأطفال.",
    ...
    specs: [
      ...
      {
        label: "طرق الفتح",
        value: "رمز · بطاقة · بصمة الإصبع · تطبيق · مفتاح ميكانيكي",
      },
      {
        label: "خيار إضافي",
        value: "كاميرا HD لمراقبة الدخول والخروج",
      },
      {
        label: "المادة",
        value: "سبيكة من الألومنيوم",
      },
      ...
      { label: "الطاقة", value: "8 بطاريات AA قلوية" },
      { label: "عمر البطارية", value: "12 شهرًا (بطاريات AA)" },
      { label: "درجة الحرارة", value: "-15 °C إلى +60 °C" },
      { label: "الاتصال", value: "واي فاي 2.4 GHz + بلوتوث" },
      { label: "التطبيق", value: "Tuya Smart أو TT Lock (iOS وAndroid)" },
      { label: "المساعد الصوتي", value: "Amazon Alexa وGoogle Home" },
      { label: "الضمان", value: "سنتان — قطع غيار وخدمة" },
      {
        label: "التوصيل",
        value: "توصيل سريع · في جميع أنحاء المغرب · التركيب مشمول",
      },
    ],
    ...
    reviews: [
      {
        name: "يوسف ك.",
        city: "الدار البيضاء",
        body: "شاشة LCD الداخلية واضحة وحادة، والكاميرا HD تُظهر الوجوه بجلاء حتى ليلًا. جرّبت مقاومته للفتح القسري — الإنذار انطلق خلال 3 ثوانٍ ووصلني الإشعار فورًا. منتج بجودة عالية فعلًا.",
      },
      {
        name: "سلمى ر.",
        city: "مراكش",
        body: "أدير ثلاثة رياض على Airbnb. فريق ARINILOCK ركّب الأقفال الثلاثة في يوم واحد وضبط كل شيء. أولّد الرموز من التطبيق في 30 ثانية. وفّر عليّ وقتًا كبيرًا.",
      },
      {
        name: "مهدي أ.",
        city: "الرباط",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "نعم — هذه إحدى أبرز مزايا M1 Pro. أنشئ رموز PIN محدودة المدة للمستأجرين دون مشاركة رمزك الرئيسي. مثالي للفلل والرياض والإيجارات القصيرة.",
      },
      {
        q: "هل التركيب مشمول؟",
    ...
    orderTitle: "هل أنت مستعد لتعزيز أمان بابك؟",
    orderDesc:
  ...
  i60: {
    ...
    specs: [
      ...
      {
        label: "البطارية",
        value: "بطارية ليثيوم أيون بسعة 5000 mAh · قابلة للشحن عبر USB-C",
      },
      ...
      { label: "رموز PIN", value: "حتى 150 مستخدمًا" },
      { label: "بطاقات IC/NFC", value: "حتى 200" },
      { label: "الضمان", value: "ضمان لمدة سنتين من الشركة" },
      { label: "التوصيل", value: "توصيل سريع · جميع أنحاء المغرب · التركيب مشمول" },
    ],
    ...
    reviews: [
      {
        name: "حميد ب.",
        city: "الرباط",
        body: "التعرف على الوجه ثلاثي الأبعاد يعمل في الظلام التام بفضل أجهزة الاستشعار بالأشعة تحت الحمراء — جرّبته في الساعة الثانية صباحًا وعمل بكفاءة. أنصح به بلا تردد.",
      },
      {
        name: "نادية ت.",
        city: "الدار البيضاء",
        body: "أعود كثيرًا ويداي ممتلئتان بالمشتريات — ميزة قراءة راحة اليد دون تلامس عملية للغاية. الشاشة الداخلية مضيئة وواضحة. فريق التركيب جاء في الوقت المحدد وكان محترفًا جدًا.",
      },
      {
        name: "كريم أ.",
        city: "فاس",
        body: "كنت أشك في المتانة لكن سبيكة الألومنيوم صلبة جدًا. يُغلق القفل تلقائيًا بعد كل إغلاق للباب. فريق الدعم اتصل بي في نفس اليوم للتأكد من أن كل شيء يعمل. نادرًا ما أرى هذا المستوى من الخدمة.",
      },
    ],
    orderSection: "10 — الطلب",
    orderTitle: "هل أنت مستعد للارتقاء بأمان منزلك؟",
    orderDesc:
      "أكمل النموذج وسيتصل بك فريقنا خلال 24 ساعة لتأكيد طلبك. الدفع عند الاستلام في جميع أنحاء المغرب.",
    orderBullets: [
      "توصيل مجاني في جميع أنحاء المغرب",
