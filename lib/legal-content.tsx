...
export const privacyContent: Record<Locale, ReactNode> = {
  fr: (
    <>
      ...
      <ul>
        ...
        <li><strong>Données de navigation</strong> : adresse IP, type de navigateur, pages visitées, via des cookies (voir section 7).</li>
  ...
  en: (
    <>
      ...
      <ul>
        ...
        <li><strong>Browsing data</strong>: IP address, browser type, pages visited, via cookies (see section 7).</li>
  ...
  ar: (
    <>
      <p>
        تلتزم ARINILOCK (يُشار إليها فيما يلي بـ«الشركة») بحماية خصوصية عملائها ومستخدميها. توضح سياسة الخصوصية هذه كيفية جمعنا واستخدامنا وحفظنا وحمايتنا لبياناتكم الشخصية، وفقًا <strong>للقانون المغربي رقم 09-08 المتعلق بحماية الأشخاص الذاتيين تجاه معالجة المعطيات ذات الطابع الشخصي</strong> ونصوصه التطبيقية.
      </p>

      <h2>1. مسؤول معالجة البيانات الشخصية</h2>
      <p>
        <strong>ARINILOCK</strong><br />
      ...
      <ul>
        ...
        <li><strong>بيانات التسليم</strong>: العنوان البريدي، المدينة.</li>
        <li><strong>بيانات الطلب</strong>: تفاصيل المنتجات المطلوبة، المبالغ، مرجع الطلب.</li>
        <li><strong>بيانات التصفح</strong>: عنوان IP، نوع المتصفح، الصفحات التي تمت زيارتها، عبر ملفات تعريف الارتباط (انظر القسم 7).</li>
        <li><strong>بيانات التواصل</strong>: الرسائل المُرسَلة عبر نموذج الاتصال أو واتساب.</li>
      </ul>
      <p>لا نجمع أي بيانات بيومترية (مثل بصمات الأصابع أو بيانات التعرف على الوجه) عبر موقعنا الإلكتروني. وتُخزَّن هذه البيانات، عند استخدامها مع أقفال ARINILOCK، محليًا على الجهاز فقط، ولا يتم إرسالها أو تخزينها على خوادمنا إطلاقًا.</p>
      ...
      <ul>
        ...
        <li>تحسين أداء موقعنا الإلكتروني وتخصيص تجربة الاستخدام.</li>
        <li>الامتثال لالتزاماتنا القانونية والمحاسبية.</li>
      </ul>

      <h2>4. الأساس القانوني للمعالجة</h2>
      <p>وفقًا للقانون 09-08، تعتمد معالجة بياناتكم على الأسس القانونية التالية:</p>
      <ul>
      ...
      <h2>5. الجهات المستفيدة من البيانات</h2>
      ...
      <ul>
        ...
        <li><strong>مزوّدي الخدمات التقنية</strong> (الاستضافة، إدارة الأنظمة، إدارة علاقات العملاء، النشرات الإخبارية) الخاضعين لالتزامات السرية.</li>
      ...
      <p>
        لممارسة هذه الحقوق، يُرجى التواصل معنا عبر: <a href="mailto:support@arinilock.ma" className={linkClass}>support@arinilock.ma</a> أو بالبريد إلى العنوان المذكور في المادة 1. سنؤكد استلام طلبكم خلال خمسة (5) أيام عمل، وسنعالجه خلال مدة لا تتجاوز ثلاثين (30) يومًا.
      </p>
      <p>
      ...
      <ul>
        ...
        <li><strong>ملفات تحليلية</strong>: تحليل استخدام الموقع وقياس عدد الزوار بصورة مجهولة الهوية (الأساس القانوني: الموافقة).</li>
      ...
      <p>
        تعتمد شركة ARINILOCK تدابير تقنية وتنظيمية مناسبة لحماية بياناتكم الشخصية من الوصول غير المصرح به أو الفقدان أو التعديل أو الإفصاح، بما في ذلك تشفير الاتصالات (HTTPS)، وتقييد صلاحيات الوصول، وإجراء مراجعات أمنية دورية.
      </p>
      ...
      <h2>10. التواصل</h2>
      <p>
        لأي استفسار يتعلق بسياسة الخصوصية أو بمعالجة بياناتكم الشخصية، يمكنكم التواصل معنا عبر:<br />
        <a href="mailto:support@arinilock.ma" className={linkClass}>support@arinilock.ma</a>
      </p>
    </>
  ),
...
export const termsContent: Record<Locale, ReactNode> = {
  fr: (
    <>
      ...
      <h2>3. Prix</h2>
      <p>
        Les prix sont indiqués en dirhams marocains (MAD), toutes taxes comprises (TTC). ARINILOCK se réserve le droit de modifier ses prix à tout moment. Les prix applicables sont ceux en vigueur au moment de la validation de la commande. La livraison et l&apos;installation sont offertes sur l&apos;ensemble du territoire marocain.
      </p>
      ...
      <h3>5.1 Paiement à la livraison (Cash on Delivery)</h3>
      <p>
      ...
      <h3>5.2 Paiement par carte bancaire</h3>
      <p>
      ...
      <h3>5.3 Sécurité des paiements</h3>
      <p>
      ...
      <h2>6. Livraison et installation</h2>
      <p>
      ...
      <h2>8. Garantie</h2>
      <p>
        Tous les produits ARINILOCK bénéficient d&apos;une garantie constructeur de 2 ans, couvrant tout défaut de fabrication dans des conditions normales d&apos;utilisation. La garantie ne couvre pas les dommages résultant d&apos;une utilisation incorrecte, d&apos;une usure normale ou d&apos;une modification non autorisée du produit.
      </p>
      <p>
  ...
  en: (
    <>
      ...
      <h2>11. Personal data protection</h2>
      <p>
  ...
  ar: (
    <>
      <p>
        تنظّم هذه الشروط العامة للبيع والاستخدام (المشار إليها فيما يلي بـ«الشروط العامة») استخدام الموقع الإلكتروني <strong>www.arinilock.ma</strong> وجميع عمليات البيع المبرمة بين شركة <strong>ARINILOCK</strong> (البائع) وأي عميل (المشتري) يقوم بتقديم طلب عبر الموقع أو عبر أي قناة بيع أخرى معتمدة من الشركة. ويُعدّ تقديم أي طلب موافقةً كاملةً وغير مشروطة على هذه الشروط العامة.
      </p>
      ...
      <h2>2. المنتجات</h2>
      <p>
        تسوّق ARINILOCK أقفالًا ذكية وملحقات منزلية ذكية للاستخدام السكني والمهني في المغرب. المنتجات مطابقة للوائح الأمنية الأوروبية (CE) والمغربية (ANRT). تُعرض أوصاف المنتجات وصورها ومواصفاتها التقنية لأغراض التعريف والإرشاد فقط. ورغم حرص ARINILOCK على دقتها، فقد تخضع بعض المواصفات أو الصور للتحديث أو التعديل دون إشعار مسبق.
      </p>

      <h2>3. الأسعار</h2>
      <p>
        تُعرض جميع الأسعار بالدرهم المغربي (MAD)، وتشمل جميع الضرائب والرسوم المطبقة. تحتفظ ARINILOCK بالحق في تعديل أسعارها في أي وقت. الأسعار المعمول بها هي تلك السارية وقت تأكيد الطلب. التوصيل والتركيب <strong>مجانيان</strong> في جميع أنحاء التراب المغربي.
      </p>

      <h2>4. الطلب</h2>
      <p>
        يُعتبر كل طلب يتم تقديمه عبر الموقع الإلكتروني أو الهاتف طلب شراء ملزمًا بعد تأكيده من قبل ARINILOCK، وذلك رهناً بتوفر المنتج. تحتفظ ARINILOCK بالحق في إلغاء أي طلب في حال نفاد المخزون أو تقديم معلومات غير صحيحة أو غير مكتملة أو الاشتباه في احتيال، مع استرداد كامل للمبلغ في حال تم الدفع.
      </p>
      <p>
      ...
      <h3>5.2 الدفع بالبطاقة البنكية</h3>
      <p>
        تقبل ARINILOCK الدفع عبر بطاقات Visa وMastercard وCMI (المركز النقدي البيني البنكي). تتم جميع عمليات الدفع عبر اتصال آمن باستخدام بروتوكول SSL، وتُعالَج عبر بوابة دفع معتمدة. لا تصل ARINILOCK إلى أي بيانات بنكية، إذ تُعالَج حصريًا من طرف مزوّد خدمة الدفع.
      </p>

      <h3>5.3 أمن المدفوعات</h3>
      <p>
      ...
      <p>
        في حال غيابكم وقت التوصيل، سيتم الاتفاق معكم على موعد جديد. لا تتحمل ARINILOCK مسؤولية أي تأخير ناتج عن قوة قاهرة أو ظروف خارجة عن إرادتها.
      </p>

      <h2>7. الحق في التراجع والإرجاع</h2>
      <p>
      ...
      <h2>8. الضمان</h2>
      <p>
        تستفيد جميع منتجات ARINILOCK من <strong>ضمان البائع لمدة سنتين</strong> يغطي عيوب التصنيع ضمن ظروف الاستخدام العادية. لا يغطي الضمان الأضرار الناتجة عن سوء الاستخدام أو تآكل عادي أو تعديل غير مصرح به للمنتج.
      </p>
      <p>
      ...
      <h2>9. المسؤولية</h2>
      <p>
        تلتزم ARINILOCK بتسليم منتجات مطابقة للأوصاف المنشورة. لا يمكن تحميل ARINILOCK المسؤولية في حال استخدام المنتج بشكل مخالف للتعليمات، أو الأضرار غير المباشرة، أو فقدان البيانات. صُممت أقفال ARINILOCK الذكية لتعزيز مستوى الأمان، ولا تُعد بديلاً عن اتخاذ التدابير الأمنية المناسبة لحماية الأشخاص أو الممتلكات.
      </p>

      <h2>10. الملكية الفكرية</h2>
      <p>
        جميع عناصر موقع www.arinilock.ma (العلامة، الشعار، النصوص، الصور، التصاميم) هي ملكية حصرية لـ ARINILOCK ومحمية بموجب القوانين المغربية المتعلقة بالملكية الفكرية. يُحظر نسخ أي جزء من محتوى الموقع أو إعادة إنتاجه أو توزيعه أو استغلاله بأي وسيلة كانت دون موافقة كتابية مسبقة من ARINILOCK.
      </p>

      <h2>11. حماية البيانات الشخصية</h2>
      <p>
        تُعالَج البيانات الشخصية التي يتم جمعها عند تقديم الطلب وفقًا لسياسة{" "}
        <NextLink href="/politique-de-confidentialite" className={linkClass}>
          الخصوصية
        </NextLink>{" "}
        الخاصة بنا، وبما يتوافق مع القانون المغربي رقم 09-08.
      </p>

      <h2>12. القانون المعمول به والنزاعات</h2>
      <p>
        تخضع هذه الشروط العامة <strong>للقانون المغربي</strong>. في حال نشوء نزاع، يسعى الطرفان أولًا إلى تسوية النزاع وديًا قبل أي لجوء قضائي. وفي حال تعذّر الاتفاق الودّي، تكون المحاكم المختصة في <strong>الدار البيضاء</strong> هي وحدها المختصة.
      </p>

      <h2>13. تعديل الشروط العامة</h2>
      <p>
        تحتفظ ARINILOCK بالحق في تعديل هذه الشروط العامة في أي وقت. تُطبَّق النسخة السارية من هذه الشروط العامة في تاريخ تقديم الطلب، وهي متاحة على هذه الصفحة.
      </p>

      <h2>14. التواصل</h2>
      <p>
        لأي استفسار يتعلق بهذه الشروط العامة للبيع والاستخدام، يمكنكم التواصل معنا عبر:<br />
        <a href="mailto:support@arinilock.ma" className={linkClass}>support@arinilock.ma</a><br />
