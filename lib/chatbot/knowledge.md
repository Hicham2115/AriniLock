...
**Prix :** 1 290 MAD (prix de lancement, au lieu de 1 590 MAD — économie de 300 MAD)  
**Finitions disponibles :** Noir Mat, Argent, Or  
**Destination :** Conçu pour le marché marocain

---

## Méthodes d'accès (5 méthodes)

1. **Empreinte digitale** — Jusqu'à 100 empreintes enregistrées. Reconnaissance et ouverture en moins d'une seconde. Jusqu'à 10 profils familiaux.
2. **Code PIN** — Code à 4–8 chiffres, modifiable à tout moment depuis l'application. Codes temporaires possibles pour les invités.
3. **Application mobile** — Verrouillez, déverrouillez et suivez l'activité de votre porte à distance. Notifications en temps réel. Historique des accès complet.
4. **Carte RFID / NFC** — Cartes NFC pour un accès rapide. Fonctionne hors connexion.
5. **Clé physique de secours** — Clé mécanique fournie avec la serrure. Toujours accessible en cas de panne totale.
...
- **Support client :** Disponible et réactif (réponse en moins d'une heure selon les avis clients)
- **Guide d'installation :** Illustré, fourni avec le produit
...
R : Oui. L'empreinte digitale, la carte RFID et la clé physique fonctionnent totalement hors connexion. L'application mobile et les notifications nécessitent une connexion internet.
...
- Points forts cités : installation facile, finition premium, application simple, autonomie batterie, support client réactif
- Utilisé par des familles, des propriétaires de locations saisonnières, des personnes âgées
