...
const UNLOCK_METHODS = [
  { icon: ScanFace,    label: "Reconnaissance faciale 3D",   desc: "Anti-usurpation · ultra-rapide" },
  { icon: Hand,        label: "Paume de la main",            desc: "Sans contact · hygiénique" },
  { icon: Fingerprint, label: "Empreinte digitale",          desc: "< 0,5 seconde · haute précision" },
  { icon: KeyRound,    label: "Code PIN sécurisé",           desc: "Anti-espionnage · codes temporaires" },
  { icon: CreditCard,  label: "Carte RFID / NFC",            desc: "Accès instantané · incluses" },
  { icon: Smartphone,  label: "Application Tuya Smart",      desc: "WiFi · iOS & Android" },
...
const REVIEWS = [
  { name: "Hamid B.",  city: "Rabat",      stars: 5, body: "Le design Push-Pull est vraiment premium. La reconnaissance faciale fonctionne même la nuit. Parfait pour ma villa." },
  { name: "Nadia T.",  city: "Casablanca", stars: 5, body: "La caméra HD et l'écran intérieur changent tout — je vois qui sonne avant d'ouvrir. Très satisfaite." },
  { name: "Karim O.",  city: "Fès",        stars: 5, body: "La reconnaissance palmaire sans contact est bluffante. Installation rapide par l'équipe AriniLock. Je recommande !" },
];
...
function Img({ label, className = "" }: { label: string; className?: string }) {
  return (
    <div className={cn("flex items-center justify-center rounded-2xl border-2 border-dashed border-gray-200 bg-gray-50", className)}>
      <div className="text-center">
        <div className="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-full border border-gray-200 bg-white">
...
function CountUp({
  to, decimals = 0, decimalSep = ".", suffix = "", duration = 1.8,
}: { to: number; decimals?: number; decimalSep?: string; suffix?: string; duration?: number }) {
  ...
  useEffect(() => {
    const unsubscribe = count.on("change", (v) => {
      ...
      ref.current.textContent = (decimals > 0 ? int + decimalSep + dec : int) + suffix;
    });
    return unsubscribe;
        ...
        >
          ...
          >
            <div className="flex flex-col">
              <span className="text-xs font-bold text-foreground">AriniLock I 60</span>
              <Stars />
            </div>
            <button
              onClick={onOrder}
          ...
          <div
            ...
            style={{ pointerEvents: "auto" }}
          >
            <span className="text-sm font-semibold text-foreground">AriniLock I 60</span>
  ...
  return (
    <>
      ...
      <main className="bg-white">
        ...
        {/* ══ 01 HERO ══ */}
        <section ref={heroRef} className="relative overflow-hidden bg-white pb-0 pt-28 lg:pt-32">
          ...
          <div className="mx-auto max-w-7xl px-6 lg:px-10">
            <div className="grid items-end gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="order-2 pb-16 lg:order-1 lg:pb-24">
                ...
                >
                  Serrure connectée haut de gamme avec reconnaissance faciale 3D, lecteur
                  de paume, caméra HD et design Push-Pull. 7 modes d&apos;accès, connectée
                  via Tuya Smart — idéale pour villas, appartements et bureaux premium.
                </motion.p>
                ...
                >
                  ...
                  <span className="text-xs text-muted-foreground">· 256 avis vérifiés</span>
                </motion.div>
                ...
                >
                  {[
                    ...
                    <span key={text} className="flex items-center gap-1.5 rounded-full border border-gray-100 bg-gray-50 px-3.5 py-1.5 text-[11px] font-medium text-muted-foreground">
              ...
              <div className="order-1 lg:order-2">
                <motion.div style={{ y: imgY }}>
                  ...
                  >
                    <Img label="Photo produit I 60 — Vue principale" className="aspect-3/4 w-full lg:rounded-none lg:rounded-tl-[2.5rem] lg:rounded-tr-[2.5rem]" />
                  </motion.div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="mx-auto max-w-7xl">
              <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
                <Reveal delay={0.05} className={cn(f.reverse ? "lg:order-2" : "lg:order-1")}>
                  <Img label={f.imgLabel} className="aspect-4/3 w-full lg:aspect-square" />
                </Reveal>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid grid-cols-2 gap-px overflow-hidden rounded-2xl bg-white/10 lg:grid-cols-4">
              {[
                ...
                { to: 0.5, decimals: 1, decimalSep: ",", suffix: "s", l: "Déverrouillage" },
          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-start gap-16 lg:grid-cols-[1fr_1.4fr] lg:gap-24">
              <div className="lg:sticky lg:top-28 lg:self-start">
                <Reveal>
                  <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.3em] text-primary/60">06 — Installation</p>
                  ...
                  <p className="mt-5 text-sm leading-relaxed text-muted-foreground">
                    Sans perçage, sans technicien, sans stress. Juste votre téléphone et le guide inclus.
                  </p>
                </Reveal>
                <Reveal delay={0.15}>
                  <Img label="Vidéo / GIF installation" className="mt-8 aspect-video w-full" />
                </Reveal>
              </div>
        ...
        <section className="border-b border-gray-100 bg-gray-50/60 px-6 py-24 lg:px-10 lg:py-32">
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.3em] text-primary/60">07 — Galerie</p>
              <h2 className="font-display2 leading-[0.9] text-foreground" style={{ fontSize: "clamp(2.4rem, 5.5vw, 4.5rem)" }}>
                Simple
                <br />
            ...
            <div className="mt-14 grid gap-3 lg:grid-cols-12">
              <Reveal delay={0.05} className="lg:col-span-8">
                <Img label="i60 — face avant Push-Pull" className="aspect-4/3 w-full lg:aspect-auto lg:h-full" />
              </Reveal>
              <div className="flex flex-col gap-3 lg:col-span-4">
                <Reveal delay={0.12}>
                  <Img label="Caméra HD + capteur facial 3D" className="aspect-square w-full" />
                </Reveal>
                <Reveal delay={0.19}>
                  <Img label="Écran LCD intérieur couleur" className="aspect-square w-full" />
                </Reveal>
              </div>
              <Reveal delay={0.1} className="lg:col-span-4">
                <Img label="Lecteur de paume sans contact" className="aspect-4/3 w-full" />
              </Reveal>
              <Reveal delay={0.15} className="lg:col-span-4">
                <Img label="Interface app Tuya Smart" className="aspect-4/3 w-full" />
              </Reveal>
              <Reveal delay={0.2} className="lg:col-span-4">
                <Img label="Contenu de la boîte" className="aspect-4/3 w-full" />
              </Reveal>
            </div>
          </div>
        </section>
        ...
        <section className="border-b border-gray-100 bg-white px-6 py-24 lg:px-10 lg:py-32">
          <div className="mx-auto max-w-7xl">
            <div className="grid gap-16 lg:grid-cols-[1fr_1.6fr] lg:gap-24">
              <div className="lg:sticky lg:top-28 lg:self-start">
                <Reveal>
                  <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.3em] text-primary/60">08 — Spécifications</p>
                  <h2 className="font-display2 leading-[0.9] text-foreground" style={{ fontSize: "clamp(2.4rem, 5.5vw, 4.5rem)" }}>
                    Tout ce
                    <br />
                    qu&apos;il faut
                ...
                {SPECS.map(({ label, value }, i) => (
                  <Reveal key={label} delay={i * 0.04}>
                    <div className="flex items-baseline justify-between gap-6 py-5">
                      <span className="shrink-0 text-[11px] font-semibold uppercase tracking-[0.15em] text-muted-foreground/70">{label}</span>
        ...
        <section className="border-b border-gray-100 bg-gray-50/60 px-6 py-24 lg:px-10 lg:py-32">
          <div className="mx-auto max-w-7xl">
            <Reveal>
              <p className="mb-3 text-[10px] font-bold uppercase tracking-[0.3em] text-primary/60">09 — Avis clients</p>
              <div className="flex items-end gap-5">
                ...
                <div className="mb-2 flex flex-col gap-1">
                  <Stars />
                  <span className="text-xs text-muted-foreground">Note moyenne 4,8 / 5</span>
                </div>
              </div>
            </Reveal>
          ...
          <div className="relative mx-auto max-w-4xl text-center">
            <Reveal>
              ...
              <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-white/55">
                Commandez votre AriniLock I 60 sur WhatsApp et recevez-le sous 48h
                partout au Maroc — avec installation professionnelle offerte.
              </p>
